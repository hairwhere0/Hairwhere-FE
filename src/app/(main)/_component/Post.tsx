            ...
            if (obj) {
              ...
              if (pageIndex !== null && pageIndex !== undefined) {
                ...
                shallow.pages[pageIndex].content[index] = {
                  ...shallow.pages[pageIndex].content[index],
                  likedNickNames: [ ...shallow.pages[pageIndex].content[index].likedNickNames, nickName as string],
          ...
          if (value) { // single 포스트도 queryKey[0]이 "posts"라 구분하는 것
            ...
            if (obj) {
              ...
              if(pageIndex !== null && pageIndex !== undefined) {
                ...
                shallow.pages[pageIndex].content[index] = {
                  ...shallow.pages[pageIndex].content[index],
                  likedNickNames: shallow.pages[pageIndex].content[index].likedNickNames.filter((v) => { v !== nickName }),
                  likeCount: shallow.pages[pageIndex].content[index].likeCount - 1
                }
                queryClient.setQueryData(queryKey, shallow);
              }
